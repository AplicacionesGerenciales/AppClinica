                                ...
                                <tbody>
                                    @foreach ($diseases as $disease)
                                        <tr>
											...
											<td>{{ $disease->name }}</td>
											<td>{{ $disease->disease_group_id }}</td>

                                            <td>
                                                <div class="modal fade" id="UpdateModal{{$disease->id}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="UpdateModalLabel" aria-hidden="true">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action ="{{ route ('diseases.update', $disease->id )}}" method = "post">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input id="name" type="text" value="{{ $disease->name }}" class="form-control input-redondeado @error('name') is-invalid @enderror" name="name"  autocomplete="off" autofocus>
                                                                        @error('name')
                                                                    ...
                                                                    <div class="col-5">
                                                                        <label class="mb-3" style='width:500px' for="diseases_group_id" >Grupo de Enfermedad</label>
                                                                            <select name="diseases_group_id" class="form-control input-redondeado" required>
                                                                            <option selected disabled value="">Seleccionar</option>
                                                                                @foreach($diseases_group as $GrupoDeExamen)
                                                                                    <option value="{{$GrupoDeExamen->id}}" {{$GrupoDeExamen->id == $disease->disease_group_id ? 'selected' : ''}} >>
                                                                                        {{$GrupoDeExamen->name}}</option>
                                                                                @endforeach
                                                                            </select>
                                                                    </div>
                                                ...
                                                <form class="Form-Delete" action="{{route('diseases.destroy',$disease->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a class = "btn btn-sm btn-primary" data-toggle="modal" data-target="#UpdateModal{{$disease->id}}" style="background-color:#01499B; color:white;">Editar

                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form class="Form-Delete" action="{{ route('files.destroy',$file->id) }}" method="POST">
                                                    ...
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editarmodal{{$file->id}}" style="text-align: center; width: 100px; height: 40px;">Editar

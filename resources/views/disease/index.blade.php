        ...
        <div class="row">
            ...
            <thead class=" thead-light">
                <tr>
                    ...
                    <th scope="col" class="color-text">Id categoría</th>
                    <th scope="col" class="color-text">Opciones</th>
                </tr>
            </thead>
            <tbody>
                @foreach($diseases as $enfermedades)
                <tr>
                    ...
                    <td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action ="{{ route ('diseases.update', $enfermedades->id )}}" method = "post">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                                <label for="name" class="col-form-label">Nombre</label>
                                                <input id="name" type="text" value="{{ $enfermedades->name }}" class="form-control input-redondeado @error('name') is-invalid @enderror" name="name"  autocomplete="off" autofocus>
                                                @error('name')
                                            ...
                                            <div class="mb-3">
                                            <label class="col-form-label" style='width:500px' for="type_examination_id" >Categoría de enfermedad</label>
                        ...
                        <form class="Form-Delete" action = "{{ route ('diseases.destroy', $enfermedades->id )}}" method = "POST">
                            @csrf
                            @method('DELETE')
                             @can('editar-enfermedad')

                            <a class = "btn btn-primary" data-toggle="modal" data-target="#UpdateModal{{$enfermedades->id}}" style="background-color:#01499B; color:white;">Editar
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{@csrf_field()}}
                    ...
                    <div class="mb-3">
                                            <label class="col-form-label" style='width:500px' for="disease_group_id	" >Categoría de enfermedad</label>
                                            <select name="disease_group_id" class="form-control input-redondeado" required>
                                            <option selected disabled value="">Seleccionar</option>
                                                @foreach($diseasesGroup as $categoria)
                                                    <option value="{{$categoria->id}}" >{{$categoria->disease_group_name}}</option>
                                                @endforeach
                                            </select>
                                            </div>
                    <div class="modal-footer">

                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @csrf
                                        @method('DELETE')
                                            <a class="btn btn-sm btn-primary " data-toggle="modal" data-target="#editarmodal{{$antecedent->id}}"><i class="fa fa-fw fa-eye"></i> {{ __('Editar') }}
                                            ...
                                            <button type="submit" class = "Form-Delete btn-danger btn btn-sm">Eliminar

                                        ...
                                        <tr>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action ="{{ route ('appointments.update', $appointment->id )}}" method = "post">
                                                                    ...
                                                                    <div class="mb-3 mb-3-extra">
                                                                        ...
                                                                        <input id="date" type="text" value="{{ $appointment->date }}" class="form-control input-redondeado @error('date') is-invalid @enderror" name="date"  autocomplete="off" autofocus>
                                                                        @error('date')
                                            ...
                                            <!-- formato de botones original -->
                                                <form class="Form-Delete" action="{{ route('appointments.destroy',$appointment->id) }}" method="POST">
                                                    ...
                                                    <button class="btn btn-danger btn-sm" id="btn-editar"><i class="fa fa-fw fa-trash"></i> {{ __('Delete') }}</button>
                                                </form>
                                            </td>
                ...
                <div class="modal-header-extra2"><h4>Datos de la Citas</h4></div>
                    <div class="modal-body">
                        <form action ="{{ route ('appointments.store')}}" method = "post">
                            ...
                            <div class="mb-3 mb-3-extra">
                                                <label for="date" class="col-form-label">Fecha</label>
                                                <input id="date" type="text" value="{{ old('date') }}" class="form-control input-redondeado @error('date') is-invalid @enderror" name="date"  autocomplete="off" autofocus>
                                                @error('date')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>

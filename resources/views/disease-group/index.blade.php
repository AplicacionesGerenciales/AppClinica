...
@section('content')
                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="col text-right">
                                <a href="{{ url ('/Disease/create') }}" class="mr-2 mt-3 btn btn-primary" >Exportar
                            ...
                            <table class="table table-striped table-hover">
                                <thead class="thead">
                                    <tr>
										...
										<th>Nombre Del Grupo Enfermedad</th>
										<th>Descripcion</th>
                                ...
                                <tbody>
                                    @foreach ($diseaseGroups as $diseaseGroup)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="modal fade" id="UpdateModal{{$diseaseGroup->id}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="UpdateModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action ="{{ route ('disease-groups.update', $diseaseGroup->id )}}" method = "post">
                                                                    @csrf
                                                                    @method('PUT')
                                                                    <div class="mb-3">
                                                                        <label for="disease_group_name" class="col-form-label">Nombre Del Grupo Enfermedad </label>
                                                                        <input id="disease_group_name" type="text" value="{{ $diseaseGroup->id }}" class="form-control input-redondeado @error('disease_group_name') is-invalid @enderror" name="disease_group_name"  autocomplete="off" autofocus>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input id="description" type="text" value="{{ $diseaseGroup->id }}" class="form-control input-redondeado @error('description') is-invalid @enderror" name="description"  autocomplete="off" autofocus>
                                                                        @error('description')
                                                                            <span class="invalid-feedback" role="alert">
                                                                                <strong>{{ $message }}</strong>
                                                                            </span>
                                            ...
                                            <form class="Form-Delete" action="{{route('disease-groups.destroy',$diseaseGroup->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <a class = "btn btn-sm btn-primary" data-toggle="modal" data-target="#UpdateModal{{$diseaseGroup->id}}" style="background-color:#01499B; color:white;">Editar
    ...
    <div class="modal fade" id="CreateModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="CreateModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form action ="{{ route('disease-groups.store') }}" method = "POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="disease_group_name" class="col-form-label">Nombre Del Grupo Enfermedad</label>
                <input id="disease_group_name" type="text"  class="form-control input-redondeado @error('disease_group_name') is-invalid @enderror" name="disease_group_name"  autocomplete="off" autofocus>
                @error('disease_group_name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="mb-3">
                    <label for="description" class="col-form-label">Descripcion</label>
                    <input id="description" type="text"  class="form-control input-redondeado @error('description') is-invalid @enderror" name="description"  autocomplete="off" autofocus>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>

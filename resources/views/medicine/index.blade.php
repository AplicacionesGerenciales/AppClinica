...
<div class="card shadow">
    <div class="row align-items-centery">
        <div class="col">
            <h3 class="color-text mt-3 ml-3">Medicamentos</h3>
        </div>
        <div class="col text-right">
            <a href="{{ url ('/Medicamento/create') }}" class="mr-2 mt-3 btn btn-primary">Exportar
            ...
            @can('crear-medicamento')

            <a class="text-white mr-3 mt-3 btn btn-primary" data-toggle="modal" data-target="#crearmodal" data-modal-origin="create">Nuevo
        ...
        <table id="datatable" class="table table-striped table-hover">
            <thead class="thead">
                <tr>
					...
					<th scope="col" class="color-text">Presentacion</th>
					<th scope="col" class="color-text">Tipo de medicamento</th>
            ...
            <tbody>
                ...
                <tr>
					...
					<td>{{ $medicine->typeMedication }}</td>
                    <td>
                        <div class="modal fade" id="UpdateModal{{$medicine->id}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="UpdateModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">Editar Medicina
                                    ...
                                    <div class="modal-body">
                                        <form action ="{{ route ('medicines.update', $medicine->id )}}" method = "post">
                                            ...
                                            @method('PUT')
                                            <div class="mb-3">
                                                <label for="name" class="col-form-label">Medicina</label>
                                                <input id="name" type="text" value="{{ $medicine->name }}" class="form-control input-redondeado @error('name') is-invalid @enderror" name="name"  autocomplete="off" autofocus>
                                                @error('name')
                                            ...
                                            <div class="mb-3">
                                                <label for="Description" class="col-form-label">Presentacion</label>
                                                <input id="Description" type="text" value="{{ $medicine->presentation }}" class="form-control input-redondeado" name="presentation">
                                            </div>
                                            <div class="mb-3">
                                                <label for="typMedication" class="col-form-label">Tipo de Medicamento</label>
                                                    <input id="typeMedication" type="text" value="{{ $medicine->typeMedication }}" class="form-control input-redondeado" name="typeMedication">
                                            </div>
                        ...
                        <form class="Form-Delete" action="{{route('medicines.destroy',$medicine->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            @can('editar-medicamento')

                            <a class = "btn btn-sm btn-primary" data-toggle="modal" data-target="#UpdateModal{{$medicine->id}}" style="background-color:#01499B; color:white;">Editar
...
<!-- Modal crear -->
<div class="modal fade" id="crearmodal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="CreateModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">Crear Medicamento
                <button type="button" class="btn-close btn-close-white" data-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                {{@csrf_field()}}
                    <div class="mb-3">
                        <label for="name" class="col-form-label mt">Nombre</label>
                        <input id="name" type="text" class="form-control input-redondeado @error('name') is-invalid @enderror" name="name" value="" autocomplete="off" autofocus>
                        @error('name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="mb-3">
                        <label for="presentation" class="col-form-label mt-3">Presentacion</label>
                        <input id="presentation" type="text" class="form-control input-redondeado @error('presentation') is-invalid @enderror" name="presentation" value="" autocomplete="off" autofocus>
                        {{-- <textarea id="presentation" class="form-control input-redondeado" name="presentation">{{old ('presentation') }}</textarea> --}}
                        @error("presentation")
                        <span class="invalid-feedback" role="alert">
                            <strong>{{$message}}</strong>
                        </span>
                    ...
                    <div class="mb-3">
                        <label for="typeMedication" class="col-form-label mt-3">Tipo de medicamento</label>
                        <input id="typeMedication" type="text" class="form-control input-redondeado @error('typeMedication') is-invalid @enderror" name="typeMedication" value="" autocomplete="off" autofocus>
                        @error('typeMedication')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        @enderror
